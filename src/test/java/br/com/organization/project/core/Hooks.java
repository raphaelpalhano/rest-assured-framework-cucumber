...
import static br.com.organization.project.constants.TimeOutConstants.MAX_TIMEOUT;
...
import br.com.organization.project.constants.AuthenticationType;
...
//		String queryStrings = ScenarioObject.getQueryStringParams();
		...
		reqBuild.setBaseUri(EnvObject.getBase_url() + pathUrl);
	}
